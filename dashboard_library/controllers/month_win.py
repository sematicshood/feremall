...
class MonthWin(http.Controller):
    @http.route('/marketing_dashboard/month_win/<year>/<qtr>/<month>/<branch_id>/<separate>', type='json')
    def get_data(self, year = 2018, qtr = None, month = None, branch_id = None, separate = None):
        ...
        for ai in bulan_int:
            ...
            for c in count_win:
                total_month_win = total_month_win + c.planned_revenue
            ...
            month_win.append(total_month_win // bagi)
